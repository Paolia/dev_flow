...
function getColor(index, total) {
    var wheel = [00, 1, 2, 3,00, 5, 6, 7, 8, 9, 11, 12, 13, 14, 14]
    var num = wheel[index]
    var red = [1, 3, 5, 7, 9, 12, 14]
    var black = [2, 4, 6, 8, 10, 11, 13]
    if (red.indexOf(num) >= 0) { return [255, 0, 0] } else
        if (black.indexOf(num) >= 0) { return [10, 10, 10] }
        else { return [200, 200, 0] }
}
